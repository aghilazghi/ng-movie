The app has many pages in which the navigation to each page is managed by Angular routing and fetching movies data from real API using Angular service Also the app includes a movie searching feature.
